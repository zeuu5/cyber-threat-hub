...
Last Updated: 2026-06-13 09:27:16.086038+00:00 UTC

## Latest CVEs

- **Unknown CVE** : Sensitive data could be written to mongod.log
- **Unknown CVE** : MariaDB server has unsafe parameter handling in `wsrep_notify_cmd`
